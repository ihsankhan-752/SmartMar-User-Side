...
import 'package:smart_mart_user_side/lib/views/profile/widgets/order_info_card.dart';
import 'package:smart_mart_user_side/lib/views/profile/widgets/order_rating_screen.dart';
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        OrderInfoCard(
                                                            title: "Phone", value: orderInfo['customerPhone']),
                                                        OrderInfoCard(
                                                            title: "Email", value: orderInfo['customerEmail']),
                                                        OrderInfoCard(
                                                            title: "Address", value: orderInfo['customerAddress']),
                                                        OrderInfoCard(
                                                            title: "Payment Status", value: orderInfo['paymentStatus']),
                                                        OrderInfoCard(
                                                            title: "Order Status", value: orderInfo['orderStatus']),
                                                      ],
                                                    ),
                                                  );
                                                });
